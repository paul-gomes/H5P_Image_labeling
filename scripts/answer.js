...
//         // this.$element.trigger("drag", function( event ) {

//         // }, false);

//         // this.$element.trigger("dragstart", function( event ) {
...
//         // this.$element.trigger("dragend", function( event ) {
...
//         // this.$element.trigger("dragleave", function( event ) {
